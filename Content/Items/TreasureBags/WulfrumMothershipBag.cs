...
namespace CalamityAddon.Content.Items.TreasureBags
{
    public class WulfrumMothershipBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            // Оружия из Calamity
            var weapons = new System.Collections.Generic.List<int>();
            weapons.Add(ModContent.ItemType<WulfrumLuncher>());

            if (weapons.Count > 0)
            {
                itemLoot.Add(ItemDropRule.OneFromOptions(1, weapons.ToArray()));
            }
